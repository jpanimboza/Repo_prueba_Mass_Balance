Geoglacier <- function(rawData, shapes_path, dem, Resolution, crsID, N.Obs,summit, geodetic_balance, m){
  ...
  source("./functions/Lliboutry_NL_shiny.r")
  ...
  source("./functions/BrickBuilder_shiny.R")
  ...
  source("./functions/B_LMf_W_shiny.R")
  aux = 0
  ...
  aux = 0
  source("./functions/B_LMf_Idw_shiny.R")
  ...
  aux = 0
  source("./functions/B_LMf_Krg_shiny.R")
  ...
  if (!is.null(geodetic_balance)){
    ...
    for (k in 1:(nrow(geo_df)-1)) {
      ...
      if (yr_glc_o <= yr_geo_o & yr_glc_f >= yr_geo_f) {
        ...
        source("./functions/Reanal_glac_geo_Zemp_shiny.R")
